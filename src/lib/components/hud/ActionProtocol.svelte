...
">
  ...
  <div class="hud-mono mb-3" style="font-size: 16px; letter-spacing: 0.01em; color: #94a3b8; line-height: 1.3; font-weight: 400;">
    ACTION: <span style="color: #94a3b8; font-weight: 400; letter-spacing: 0;">[{protocolLabel}]</span>
    <span style="color: {statusColor}; font-weight: 400; letter-spacing: 0;"> [{status}]</span>
  </div>
