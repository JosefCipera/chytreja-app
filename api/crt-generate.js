...
export default async function handler(req, res) {
  ...
  // Výběr modelu: sonnet5 default (nejlepší výsledek), fable/opus jako alternativy přes ?model=
  // Fable s effort:null (high) spotřebovával příliš tokenů na thinking → prázdný JSON výstup
  const MODEL_MAP = {
    opus:    { id: 'claude-opus-4-8',  thinking: false, effort: null,  maxTokens: 8000 },
    sonnet5: { id: 'claude-sonnet-5',  thinking: true,  effort: 'low', maxTokens: 32000 },
